    ...
    <style>
        * {
        ...
        #right {
            ...
            justify-content: flex-start; /* 垂直方向は上寄せを維持 */
            padding: 20px;
        }
        ...
        .form-container {
            ...
            width: 600px;
            margin-top: 20px; /* 上部の余白は維持 */
            /* 以下を追加して垂直方向にも中央揃えにする場合 */
            /* display: flex;
            flex-direction: column;
            align-items: center; */
        }
        ...
        <div id="right">
            <div class="content">
                ...
                <div class="form-container">
                    <form action="/display/studentcreate" method="post">
